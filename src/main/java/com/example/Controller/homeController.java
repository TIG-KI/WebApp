...
/*登陆界面控制台*/
@SessionAttributes(value = {"schoolnumber"})
@Controller
public class homeController{
    ...
    public String findByUsernameAndPassword(@RequestParam("password")String password,
        ...
        * 那么页面将进行跳转*/
        ...
        if (Fuser.isEmpty()){
            ...
            * 这里用到 redirect 定向跳转；redirect 后跟MainPageController 中的一个映射/MainPage ;*/
            /*attributes.addFlashAttribute("schoolnumber",schoolnumber);*/
